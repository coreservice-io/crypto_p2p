...
// writes the little endian representation of element to w.
func writeElement(w io.Writer, element interface{}) error {
...
// It is equivalent to multiple calls to writeElement.
func writeElements(w io.Writer, elements ...interface{}) error {
	for _, element := range elements {
...
// reads a variable length string from r and returns it as a Go string.
